...
def index():
    ...
    tax_prep_mode = request.args.get('tax_prep') == '1'
        ...
        try:
            ...
            user_streak = reminders.get_user_streak(db, current_user.id)
            ...
            logger.warning(f"Could not determine if daily log reminder, streak, unpaid debts/credits, or inventory loss needed: {str(e)}")
        ...
        try:
            if tax_prep_mode:
                ...
                # Optionally, clear other stats or set to 0
